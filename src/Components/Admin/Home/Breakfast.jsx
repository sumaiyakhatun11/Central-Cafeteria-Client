...
const Breakfast = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h2 className="text-3xl font-bold mb-6 text-center">Breakfast Menu</h2>
            <div className="lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 hidden ">
                    ...
                    <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-lg font-semibold text-red-700">{item.price} tk</span>
